    ...
    for each_line in file:
        try:
            ...
            try:
                ...
                logging.error("base_info error..."+url)
                fangwuhuxing = ""
                louceng = ""
                mianji = ""
                chaoxiang = ""
            ...
            try:
                ...
                logging.error("jianzhushijian error..."+url)
                jianzhushijian = ""
            ...
            logging.info("one house is collected...")
        except HTTPError:
            logging.info("the house is sold..."+url)
    file.close()
    out.close()
#创建5个进程的进程池
